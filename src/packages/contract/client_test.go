...
func TestConntractCall(t *testing.T) {
	...
	out, err := abi.Pack("getUserAccountData", common.HexToAddress("0x9BD3e72f2F1CA05Ad8D4489ec870Bf2478b10397"))
	if err != nil {
		panic(err)
	}
	res, err := eth.CallContractFunction("0x"+hex.EncodeToString(out), "0x9FAD24f572045c7869117160A571B2e50b10d068", ethrpc.DefaultCallGas)
	if err != nil {
		panic(err)
	}
	fmt.Println(res)
	...
	err = abi.UnpackIntoMap(v, "getUserAccountData", bytes)
	if err != nil {
		panic(err)
	}
	fmt.Printf("%+v\n", v["healthFactor"])
...
func TestExampleViewCall(t *testing.T) {
	...
	res, err := eth.CallContractFunction("0x"+hex.EncodeToString(packed), "0x9FAD24f572045c7869117160A571B2e50b10d068", ethrpc.DefaultCallGas)
	if err != nil {
		panic(err)
	}
